...
export class EmployeeDashboardComponent implements OnInit {
  ...
  this.filteredEmployeeData = [...this.employeeData];  // Initialiser filteredEmployeeData
  }
  ...
  filterEmployees() {
    ...
    this.filteredEmployeeData = this.employeeData.filter((employee: { firstName: string; lastName: string; email: string; mobile: string | string[]; }) => {
      return (
